...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'bayyou@houtlook.me',
  ...
  footer:
    'Powered by <a href="https://cloudflare.com" target="_blank" rel="noopener noreferrer">CF</a>. Made with ❤',
